...
static Keychord *keychords[] = {
	...
	&((Keychord){1,	{{0, XF86XK_AudioLowerVolume}},	spawn,		SHCMD("amixer sset Master 5%-") }),
	&((Keychord){1, {{0, XF86XK_AudioRaiseVolume}},	spawn,		SHCMD("amixer sset Master 5%+") }),
	&((Keychord){1,	{{0, XF86XK_AudioMute}},	spawn,		SHCMD("amixer -D pulse set Master toggle") }),
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
